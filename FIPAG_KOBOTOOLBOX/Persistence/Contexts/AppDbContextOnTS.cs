...
{
    public partial class AppDbContextOnTS : DbContext
    {
        public AppDbContextOnTS()
        {
        }

        public AppDbContextOnTS(DbContextOptions<AppDbContextOnTS> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer(configuration.GetConnectionString("DBconnect_OnTS_FIPAG"));
        }
